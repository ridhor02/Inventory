    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-white sidebar sidebar-light accordion shadow-sm" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex text-white align-items-center bg-primary justify-content-center" href="">
                ...
                <div class="sidebar-brand-text mx-3">IMSystem</div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Category Barang</a>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Barang</a>
                        <a class="collapse-item" href="<?= base_url('wh'); ?>">Data Warehouse</a>
                        <a class="collapse-item" href="<?= base_url('mnemonic'); ?>">Data Mnemonic</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url(''); ?>">
                    <i class="fas fa-fw fa-upload"></i>
                    <span>Manual Requested Form</span>
                </a>
            </li>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright @2020 &copy; Inventory & Catalogue PT Antang Gunung Meratus &bull; by <?= anchor('https://www.ridho.id', 'MRidhoR'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
